                ...
                .properties =
                    {
                        ...
                        {"photo_filename", {
                            ...
                            "obtained by #take_photo or #search_photo_in_gallery tool; althrough you can attach any"
                            "file as soon as their filename is correct. Pass null if not attaching a photo.",
                            .nullable = true},
                        },
                        {"audio_filename", {
                            .type = "string",
